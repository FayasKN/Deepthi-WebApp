...
export const animalsData: ContentItem[] = [
  ...
  { id: "bird",     name_en: "Bird",     name_ml: "പക്ഷി",    emoji: "🐦", image: "/images/animals/bird.png",     audio_en: "/audio/en/bird.mp3",     audio_ml: "/audio/ml/bird.mp3",     sound: "/audio/sounds/bird.mp3" },
];
